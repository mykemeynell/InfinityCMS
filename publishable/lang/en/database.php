...
return [
    ...
    'relationship'              => [
        ...
        'before_create'        => 'Before you can create a new relationship you will need to create the BREAD first.<br> Then, return to edit the BREAD and you will be able to add relationships.<br> Thanks.',
        'cancel'               => 'Cancel',
